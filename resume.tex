...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}\textbf{Traba} & New York, NY\\\end{tabular*}
    \item\begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}\textit{\small{Senior Software Engineer}} & \textit{\small{Jul 2024 -- Oct 2025}}\\\end{tabular*}
    \begin{itemize}
